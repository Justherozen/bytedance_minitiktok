...
public class DataCreate {
    ...
    public void initData() {
        ...
        userBeanThree.setNickName("体育快讯");
        ...
        userBeanFour.setNickName("修图师小白");
